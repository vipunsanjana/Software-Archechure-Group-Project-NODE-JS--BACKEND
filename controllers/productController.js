...
export const braintreeTokenController = async (req, res) => {
  try {
    ...
    console.error('Error in braintreeTokenController:', error);
...
const sendConfirmationEmail = async (userEmail) => {
  try {
    ...
    let info = await transporter.sendMail({
      ...
      subject: "Payment Successfull!Order Confirm!", // Subject line
      text: "Payment Successfull!Order Confirm!", // plain text body
...
export const brainTreePaymentController = async (req, res) => {
  try {
    ...
    // Assuming you've already calculated the total price and want to process the order for Cash on Delivery (COD)
    try {
      const order = new orderModel({
        products: cart,
        payment: "COD", // Cash on Delivery
        buyer: req.user._id, // Assuming you have user ID available in the request
      });
      await order.save();
      res.json({ ok: true });
    } catch (error) {
